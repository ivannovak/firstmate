...
"  label();",
"",
"  var live = !!(window.lavish && typeof window.lavish.queuePrompt === 'function');",
"  if (!live) {",
"    Array.prototype.forEach.call(document.querySelectorAll('[data-fm-offline]'), function (el) { el.hidden = false; });",
"    Array.prototype.forEach.call(document.querySelectorAll('[data-fm-decision-form] button'), function (el) { el.disabled = true; });",
"    return;",
"  }",
"",
